    ...
    <body>
        ...
        <div class="container mt-5">
            <c:url var="addToCart" value="/cart/addToCart">
                ...
                <c:param name="jspName" value="storage/information/${product.id}"/>
            </c:url>
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div>
                        <ul class="oneprodatributes">
                            ...
                            <li>Size: ${storageSize}"</li>
                            <li>Type: ${storageType}</li>
                            <li>Manufacturer: ${storageManufacturer}</li>
            ...
            <div class="relprod">
                <c:forEach items="${listOfProducts}" var="q">
                    <c:url var="addToCart" value="/cart/addToCart">
                        ...
                        <c:param name="jspName" value="storage/information/${q.id}"/>
                    </c:url>
                    <div class="relatedproduct col-12 col-md-3 my-3">

                        <a href="${pageContext.request.contextPath}/storage/information/${q.id}">
                            <img src="http://localhost:8080/images/${q.id}.jpg" alt="TODO" height="100%" width="100%">
                        </a>

                        <div class="mt-3">
                            <p><a href="${pageContext.request.contextPath}/storage/information/${q.id}">${q.name}</a></p>
                        </div>
                        <div>
