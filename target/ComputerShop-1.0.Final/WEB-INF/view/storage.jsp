        ...
        <div class="container mt-5">
            <security:authorize access="hasRole('ADMIN')">
                <div id="form" >
                    ...
                    <form:form 
                        action="${pageContext.request.contextPath}/storage/add" 
                        method="POST"
                ...
                <div class="btn-group">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/storage/price/0/75">up to 75€</a>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/storage/price/75/150">75€ up to 150€</a>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/storage/price/150/225">150€ up to 225€</a>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/storage/price/225/300">225€ up to 300€</a>
                        </div>
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <c:forEach items="${manufacturers}" var="p">
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/storage/manufacturer/${p.getId()}">${p.name}</a>
                            </c:forEach>
                        </div>
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <c:forEach items="${types}" var="p">
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/storage/type/${p.getId()}">${p.name}</a>
                            </c:forEach>
                        </div>
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <c:forEach items="${inches}" var="p">
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/storage/inches/${p.getId()}">${p.name}"</a>
                            </c:forEach>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mt-5">
                <!--                <h3 class="text-md-left">Storage Device</h3>-->
                <div class="title">
                    <img src="${pageContext.request.contextPath}/static/geekfonts/storage.png" alt="storage">
                </div>
                <c:choose>
                    <c:when test="${productList.size()>0}">
                        <c:forEach items="${productList}" var="q" varStatus="status">
                            <c:url var="addToCart" value="/cart/addToCart">
                                ...
                                <c:param name="jspName" value="storage"/>
                            </c:url>
                            <c:url value="/storage/update" var="updateLink" >
                                <c:param name="productId" value="${q.id}" />
                            </c:url>

                            <c:url value="/storage/delete" var="deleteLink">
                                <c:param name="productId" value="${q.id}" />
                            </c:url>

                            <!--more information*************************************************************************************-->
                            <c:url value="/storage/information/${q.id}" var="informationLink">
                                <c:param name="productId" value="${q.id}" />
                            </c:url>
                            <div class="divproduct row col-12 col-md-12">
                                ...
                                <div class="indivproduct col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6"> Size: ${storageList[status.index].inches}"</div>

                                    </div>
                                    <div class="row">
                                        <div class="col-6">Category: <span class="category"><a
                                                    href="${pageContext.request.contextPath}/displayByCategory/${q.category.getId()}">
                                                    ${q.category}</a></span></div>
                                        <div class="col-6">Manufacturer: ${storageList[status.index].manufacturer}</div>
                                ...
                                <div class="indivproduct col-12 col-md-2">
                                    ...
                                    <div>
                                        Type: ${storageList[status.index].type}
                                    </div>
                                </div>
                                <div class="indivproduct col-12 col-md-2">
                                    <div class="price">
