...
<html>
    ...
    <body>
        <a href="${pageContext.request.contextPath}" class="logo-creditCart">
        ...
        <div id="form-container">
            ...
            <button type="button" id="card-btn" onclick="window.location.href='${pageContext.request.contextPath}/cart/final';">Submit</button>
