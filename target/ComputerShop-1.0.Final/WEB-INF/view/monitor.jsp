        ...
        <div class="container mt-5">
            <security:authorize access="hasRole('ADMIN')">
                <div id="form" >
                    ...
                    <form:form 
                        action="${pageContext.request.contextPath}/monitor/add" 
                        method="POST"
                        ...
                        <div class="formes col-12 row">
                            <div class="col-3">
                                ...
                                <input type="text" id="ammount" class="form-control" value="${ammountt}" name="ammountt"/><span style="color:red;"><c:out value="${msgNumbersAmmount}"/></span>
                            </div>
                            <div class="col-3">
                                <label for="frequency">Enter Frequency:</label>
                                <input type="number" value="${Hz}" id="frequency" class="form-control" placeholder ="" name="Hz">
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-3">
                                <label for="inches">Select Size:</label>
                                <select id="inches" class="form-control" name="inches">
                                    <optgroup label = "Select Size">
                                        <c:forEach items="${inches}" var="c"> 
                ...
                <div class="btn-group">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/monitor/price/0/100">up to 100€</a>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/monitor/price/100/150">100€ up to 150€</a>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/monitor/price/150/200">150€ up to 200€</a>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/monitor/price/200/250">200€ up to 250€</a>
                        </div>
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <c:forEach items="${manufacturers}" var="p">
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/monitor/manufacturer/${p.getId()}">${p.name}</a>
                            </c:forEach>
                        </div>
                    </div>
                    <!--INCHES-->
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <c:forEach items="${inches}" var="p">
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/monitor/inches/${p}">${p}"</a>
                            </c:forEach>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mt-5">
                <!--<h3 class="text-md-left">Monitor</h3>-->
                <div class="title">
                <img src="${pageContext.request.contextPath}/static/geekfonts/Monitor.png" alt="Monitor">
            </div>
                <c:choose>
                    <c:when test="${productList.size()>0}">
                        <c:forEach items="${productList}" var="q" varStatus="status">
                            <c:url var="addToCart" value="/cart/addToCart">
                                ...
                                <c:param name="jspName" value="monitor"/>
                            </c:url>
                            <c:url value="/monitor/update" var="updateLink" >
                                <c:param name="productId" value="${q.id}" />
                            </c:url>

                            <c:url value="/monitor/delete" var="deleteLink">
                                <c:param name="productId" value="${q.id}" />
                            </c:url>

                            <!--more information*************************************************************************************-->
                            <c:url value="/monitor/information/${q.id}" var="informationLink">
                                <c:param name="productId" value="${q.id}" />
                            </c:url>
                            <div class="divproduct row col-12 col-md-12">
                                ...
                                <div class="indivproduct col-12 col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">Size: ${monitorList[status.index].inches}"</div>

                                    </div>
                                    <div class="row">
                                        <div class="col-6">Category: <span class="category"><a
                                                href="${pageContext.request.contextPath}/monitor">
                                                    ${q.category}</a></span></div>
                                        <div class="col-6">Manufacturer: ${monitorList[status.index].manufacturer}</div>
                                ...
                                <div class="indivproduct col-12 col-md-2">
                                    ...
                                    <div>
                                        Frequency: ${monitorList[status.index].getHz()}Hz
                                    </div>
                                </div>
                                <div class="indivproduct col-12 col-md-2">
                                    <div class="price">
