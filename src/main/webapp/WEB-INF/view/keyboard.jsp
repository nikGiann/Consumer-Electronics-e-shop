...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <div class="title">
                <img src="${pageContext.request.contextPath}/static/geekfonts/keyboards.png" alt="keyboards">
            </div>
            <c:choose>
                <c:when test="${productList.size()>0}">
                    <c:forEach items="${productList}" var="q" varStatus="status">
                        ...
                        <c:url value="/keyboard/update" var="updateLink" >
                            <c:param name="productId" value="${q.id}" />
                        </c:url>

                        <c:url value="/keyboard/delete" var="deleteLink">
                            <c:param name="productId" value="${q.id}" />
                        </c:url>

                        <!--more information*************************************************************************************-->
                        <c:url value="/keyboard/information/${q.id}" var="informationLink">
                            <c:param name="productId" value="${q.id}" />
                        </c:url>
