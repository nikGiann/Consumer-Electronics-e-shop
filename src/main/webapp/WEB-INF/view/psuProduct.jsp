    ...
    <body>
        ...
        <div class="container mt-5">
            <c:url var="addToCart" value="/cart/addToCart">
                ...
                <c:param name="jspName" value="psu/information/${product.id}"/>
            </c:url>
            <div class="row col-12 col-md-12 mt-5">
                <div class="product col-4 col-md-4">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div>
                        <ul class="oneprodatributes">
                            ...
                            <li>Power: ${psuPower}W</li>
                            <li>Cable Management: ${psuCableManagement}</li>
                            <li>Efficiency: ${psuEfficiency}</li>
                            <li>Manufacturer: ${psuManufacturer}</li>
            ...
            <div class="relprod">
                <c:forEach items="${listOfProducts}" var="q">
                    <c:url var="addToCart" value="/cart/addToCart">
                        ...
                        <c:param name="jspName" value="psu/information/${q.id}"/>
                    </c:url>
                    <div class="relatedproduct col-12 col-md-3">

                        <a href="${pageContext.request.contextPath}/psu/information/${q.id}">
                            <img src="http://localhost:8080/images/${q.id}.jpg" alt="TODO" height="100%" width="100%">
                        </a>

                        <div class="mt-3">
                            <p><a href="${pageContext.request.contextPath}/psu/information/${q.id}">${q.name}</a></p>
                        </div>
