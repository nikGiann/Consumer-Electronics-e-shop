    ...
    <body>
        ...
        <div class="container mt-5">
            <c:url var="addToCart" value="/cart/addToCart">
                ...
                <c:param name="jspName" value="ram/information/${product.id}"/>
            </c:url>
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div>
                        <ul class="oneprodatributes">
                            ...
                            <li>Type: ${ramType}</li>
                            <li>Voltage: ${ramVoltage}V</li>
                            <li>Frequency: ${ramFrequency}MHz</li>
                            <li>Size: ${ramSize}</li>
                            <li>Manufacturer: ${ramManufacturer}</li>
            ...
            <div class="relprod">
                <c:forEach items="${listOfProducts}" var="q">
                    <c:url var="addToCart" value="/cart/addToCart">
                        ...
                        <c:param name="jspName" value="ram/information/${q.id}"/>
                    </c:url>
                    <div class="relatedproduct col-12 col-md-3">

                        <a href="${pageContext.request.contextPath}/ram/information/${q.id}">
                            <img src="http://localhost:8080/images/${q.id}.jpg" alt="TODO" height="100%" width="100%">
                        </a>

                        <div class="mt-3">
                            <p><a href="${pageContext.request.contextPath}/ram/information/${q.id}">${q.name}</a></p>
                        </div>
