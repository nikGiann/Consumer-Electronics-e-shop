    ...
    <body>
        ...
        <div class="container mt-5">
            <c:url var="addToCart" value="/cart/addToCart">
                ...
                <c:param name="jspName" value="mouse/information/${product.id}"/>
            </c:url>
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div>
                        <ul class="oneprodatributes">
                            ...
                            <li>Type: ${mouseType}</li>
                            <li>Manufacturer: ${mouseManufacturer}</li>
            ...
            <div class="relprod">
                <c:forEach items="${listOfProducts}" var="q">
                    <c:url var="addToCart" value="/cart/addToCart">
                        ...
                        <c:param name="jspName" value="mouse/information/${q.id}"/>
                    </c:url>
                    <div class="relatedproduct col-12 col-md-3">

                        <a href="${pageContext.request.contextPath}/mouse/information/${q.id}">
                            <img src="http://localhost:8080/images/${q.id}.jpg" alt="TODO" height="100%" width="100%">
                        </a>

                        <div class="mt-3">
                            <p><a href="${pageContext.request.contextPath}/mouse/information/${q.id}">${q.name}</a></p>
                        </div>
