    ...
    <body>
        ...
        <div class="container mt-5">
                ...
                <div id="form" >
                    ...
                    <form:form 
                        ...
                        <div class="formes col-12 row">
                            ...
                            <div class="col-3">
                                <label for="cable">Select Cable Management:</label>
                                <select id="cable" class="form-control" name="cable">
                            ...
                            <div class="col-3">
                                <label for="efficiency">Select Efficiency:</label>
                                <select id="efficiency" class="form-control" name="efficiency">
                            ...
                            <div class="col-3">
                                <label for="watt">Select Power:</label>
                                <select id="watt" class="form-control" name="watt">
            ...
            <div class="container mt-5">
                ...
                <div class="title">
                    <img src="${pageContext.request.contextPath}/static/geekfonts/psu.png" alt="psu">
                </div>
                <c:choose>
                    <c:when test="${productList.size()>0}">
                        <c:forEach items="${productList}" var="q" varStatus="status">
                            ...
                            <c:url value="/psu/update" var="updateLink" >
                                <c:param name="productId" value="${q.id}" />
                            </c:url>

                            <c:url value="/psu/delete" var="deleteLink">
                                <c:param name="productId" value="${q.id}" />
                            </c:url>

                            <!--more information*************************************************************************************-->
                            <c:url value="/psu/information/${q.id}" var="informationLink">
                                <c:param name="productId" value="${q.id}" />
                            </c:url>
