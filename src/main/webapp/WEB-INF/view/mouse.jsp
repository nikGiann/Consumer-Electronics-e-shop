...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-5">
            <security:authorize access="hasRole('ADMIN')">
                <div id="form" >
                    ...
                    <form:form 
                        action="${pageContext.request.contextPath}/mouse/add" 
                        method="POST"
            ...
            <div class="btn-group">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/mouse/price/0/40">up to 40€</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/mouse/price/40/80">40€ up to 80€</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/mouse/price/80/120">80€ up to 120€</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/mouse/price/120/160">120€ up to 160€</a>
                    </div>
                </div>
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <c:forEach items="${manufacturers}" var="p">
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/mouse/manufacturer/${p.getId()}">${p.name}</a>
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <c:forEach items="${types}" var="p">
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/mouse/type/${p.getId()}">${p.name}</a>
        ...
        <div class="container mt-5">
            <!--            <h3 class="text-md-left">Mouse</h3>-->
            <div class="title">
                <img src="${pageContext.request.contextPath}/static/geekfonts/mouses.png" alt="mouses">
            </div>
            <c:choose>
                <c:when test="${productList.size()>0}">
                    <c:forEach items="${productList}" var="q" varStatus="status">
                        <c:url var="addToCart" value="/cart/addToCart">
                            ...
                            <c:param name="jspName" value="mouse"/>
                        </c:url>
                        <c:url value="/mouse/update" var="updateLink" >
                            <c:param name="productId" value="${q.id}" />
                        </c:url>

                        <c:url value="/mouse/delete" var="deleteLink">
                            <c:param name="productId" value="${q.id}" />
                        </c:url>

                        <!--more information*************************************************************************************-->
                        <c:url value="/mouse/information/${q.id}" var="informationLink">
                            <c:param name="productId" value="${q.id}" />
                        </c:url>
                        <div class="divproduct row col-12 col-md-12">
                            ...
                            <div class="indivproduct col-12 col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6"> Type: ${mouseList[status.index].type}</div>

                                </div>
                                <div class="row">
                                    <div class="col-6">Category: <span class="category"><a
                                                href="${pageContext.request.contextPath}/mouse">
                                                ${q.category}</a></span></div>
                                    <div class="col-6">Manufacturer: ${mouseList[status.index].manufacturer}</div>
