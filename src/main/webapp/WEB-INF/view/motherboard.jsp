...
<html lang="en">
    ...
    <body>
                ...
                <div id="form" >
                    ...
                    <form:form 
                        ...
                        <div class="formes col-12 row">
                            ...
                            <div class="col-3">
                                <label for="socket">Select Socket:</label>
                                <select id="socket" class="form-control" name="socket">
                                    <optgroup label = "Select Socket">
                                        <c:forEach items="${sockets}" var="t"> 
                            ...
                            <div class="col-3">
                                ...
                                <select id="chipset" class="form-control" name="chipset">
                                    <optgroup label = "Select Chipset">
                                        <c:forEach items="${chipsets}" var="t"> 
                                            <option value="${t.getId()}">${t.name}</option>
                                        </c:forEach>
                                    </optgroup>
                                </select>
                        ...
                        <div class="formes col-12 row">
                            <div class="col-3">
                                ...
                                <select id="ports" class="form-control" name="ports">
                                    <optgroup label = "Select Ports">
                                        <c:forEach items="${ports}" var="t"> 
                                            <option value="${t.getId()}">${t.name}</option>
                                        </c:forEach>
                                    </optgroup>
                                </select>
        ...
        <div class="container mt-5">
            ...
            <div class="title">
                <img src="${pageContext.request.contextPath}/static/geekfonts/motherboards.png" alt="motherboards">
            </div>
            <c:choose>
                <c:when test="${productList.size()>0}">
                    <c:forEach items="${productList}" var="q" varStatus="status">
                        ...
                        <c:url value="/motherboard/update" var="updateLink" >
                            <c:param name="productId" value="${q.id}" />
                        </c:url>

                        <c:url value="/motherboard/delete" var="deleteLink">
                            <c:param name="productId" value="${q.id}" />
                        </c:url>

                        <!--more information*************************************************************************************-->
                        <c:url value="/motherboard/information/${q.id}" var="informationLink">
                            <c:param name="productId" value="${q.id}" />
                        </c:url>

                        <div class="divproduct row col-12 col-md-12">

                            <a href="${informationLink}"><img class="indivproduct col-12 col-md-2" src="http://localhost:8080/images/${q.id}.jpg" alt="TODO" ></a>
