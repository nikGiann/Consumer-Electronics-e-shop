...
<html lang="en">
    ...
    <body>
                    ...
                    <form:form 
                        ...
                        <div class="formes col-12 row">
                            ...
                            <div class="col-3">
                                ...
                                <select id="chip" class="form-control" name = "chip">
                            ...
                            <div class="col-3">
                                <label for="cores">Select Cores:</label>
        ...
        <div class="container mt-5">
            ...
            <div class="title">
                <img src="${pageContext.request.contextPath}/static/geekfonts/cpu.png" alt="cpu">
            </div>
            <c:choose>
                <c:when test="${productList.size()>0}">
                    <c:forEach items="${productList}" var="q" varStatus="status">
                        ...
                        <c:url value="/cpu/update" var="updateLink" >
                            <c:param name="productId" value="${q.id}" />
                        </c:url>
                        <c:url value="/cpu/delete" var="deleteLink">
                            <c:param name="productId" value="${q.id}" />
                        </c:url>                    
                        <!--more information*************************************************************************************-->
                        <c:url value="/cpu/information/${q.id}" var="informationLink">
                            <c:param name="productId" value="${q.id}" />
                        </c:url>
                        ...
                        <div class="divproduct row col-12 col-md-12">
                            ...
                            <div class="indivproduct col-12 col-md-8">
                                <div>
                                    <p><a href="${informationLink}">${q.name}</a><p>
                                </div>
                                <div class="row">
                                    <div class="col-4">Code: ${q.pcode}</div>
                                    <div class="col-4">Cores: ${cpuList[status.index].getCoresNumber()}</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">  Manufacturer: ${cpuList[status.index].cpuManufacturer}</div>
                                    <div class="col-4">
